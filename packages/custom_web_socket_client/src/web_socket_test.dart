  ...
  group('WebSocket', () {
    ...
    group('connection', () {
      test(
        ...
        final socket = WebSocketClient(uri: uri);
      ...
      test(
        ...
        final socket = WebSocketClient(uri: uri, backoff: backoff);
      ...
      test(
        ...
        final socket = WebSocketClient(
          ...
          backoff: const ConstantBackoff(duration: Duration.zero),
        );
    ...
    group('send', () {
      test('does nothing when connection is closed', () async {
        ...
        expect(() => socket.add(null), returnsNormally);
